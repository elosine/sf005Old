...
function makeControlPanel() {
  ...
  let goToField_w = 18;
  let goToField_h = 18;
  let goToField_top = CTRLPANEL_MARGIN + (BUTTON_GAP * 3) + 18;
  ...
  let pieceIdDisplayLbl = mkSpan({
    canvas: controlPanelPanel.content,
    top: CTRLPANEL_MARGIN + (BUTTON_GAP * 3) + 18 + 18 + 11 + BUTTON_GAP + 4,
  ...
  let pieceIdDisplay = mkSpan({
    canvas: controlPanelPanel.content,
    top: CTRLPANEL_MARGIN + (BUTTON_GAP * 3) + 18 + 18 + 11 + BUTTON_GAP + 4 + 15,
    left: CTRLPANEL_MARGIN + 11,
